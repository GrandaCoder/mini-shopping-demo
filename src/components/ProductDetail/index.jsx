    ...
    <aside
      ...
      <div className='flex flex-wrap'>
        <figure className='px-6 w-full'>
          <img className=' w-full h-80 rounded-lg object-cover' src={contexto.productoToShow.images ? contexto.productoToShow.images : 'https://images.pexels.com/photos/704555/pexels-photo-704555.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'} alt={contexto.productoToShow.title} />
        </figure>
